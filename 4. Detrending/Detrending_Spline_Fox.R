...
WestFOXDtr = detrend(WFoxEB[,-1], method = "Spline")
...
png("Dtr_Plots_spline.png", width=600, height=900)
grid.arrange(p4, p5, p6, ncol=1)
dev.off()

png("Raw_Dtr_Plots_spline.png", width=1000, height=600)
...
png("Dtr_Plots_Mean_spline.png", width=600, height=900)
grid.arrange(p10, p11,  ncol=1)
dev.off()

png("Raw_Dtr_Plots_Mean_spline.png", width=1000, height=600)
